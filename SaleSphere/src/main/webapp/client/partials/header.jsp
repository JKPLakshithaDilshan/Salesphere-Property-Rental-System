...
<head>
    ...
    <style>
        ...
        .search-container:focus-within .fas.fa-search {
            color: #06b6d4;
            transform: scale(1.1);
        }
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden lg:flex flex-1 max-w-md mx-8">
                    <div class="search-container w-full rounded-full px-4 py-2 flex items-center">
            ...
            <div id="mobileMenu" class="mobile-menu md:hidden hidden">
                <div class="px-4 py-6 space-y-4">
                    <!-- Search Bar (Mobile) -->
                    <div class="search-container rounded-xl px-4 py-3 flex items-center mb-6">
                        <i class="fas fa-search text-gray-400 mr-3"></i>
                        <input type="text" placeholder="Search properties..."
                               class="bg-transparent text-white placeholder-gray-400 w-full outline-none">
                    </div>
