...
<aside id="adminSidebar" class="sidebar-container w-60 hidden md:flex flex-col fixed h-full">
    ...
    <nav class="nav-container flex-1 overflow-y-auto">
        <div class="space-y-1">
            ...
            <!-- My Properties -->
            <a href="${pageContext.request.contextPath}/admin/my-property" class="nav-link" data-section="property">
                <i class="nav-icon fas fa-building"></i>
                <span class="nav-text">My Properties</span>
                <span class="nav-badge" style="display: none;">5</span>
            </a>
    ...
    (function() {
        ...
        async function loadNotificationCounts() {
            try {
                ...
                if (response.ok) {
                    ...
                    // Update badges
                    updateNotificationBadge('property', data.properties || 0);
                    updateNotificationBadge('maintenance', data.maintenance || 0);
        ...
        function setupPerformanceOptimizations() {
            ...
            const criticalPages = [
                ...
                '${pageContext.request.contextPath}/admin/my-property'
            ];
